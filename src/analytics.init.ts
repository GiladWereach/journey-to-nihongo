/**
 * Weave Analytics SDK Initialization
 *
 * Import this file in your app entry point:
 * import './analytics.init';
 */

import { init } from '@weave-bi/sdk';

// Initialize Weave Analytics
init({
...
console.log('[Weave] Analytics initialized for project: 7de4ea85-7135-4107-bc0c-6fcce214b4a5');
