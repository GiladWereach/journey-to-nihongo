...
import { timedChallengePageViewed, timedChallengeGameReset, timedChallengeAnswerSubmitted, timedChallengeGameStarted, timedChallengeTypeSelected, timedChallengeDashboardRedirectClicked, timedChallengeAuthRedirectClicked, useAuth, useNavigate, useToast, endGame, random, generateQuestions, setResult, toast, toString } from '@/lib/analytics-generated';
